...
; 编译: makensis /DMY_OUTPUT=RealEarthSetup-v3.1.5.exe /DSRC_DIR=dist-dir/RealEarth RealEarthSetup.nsi
...
; 允许通过命令行传入
!ifndef MY_OUTPUT
  !define MY_OUTPUT "RealEarthSetup-v3.1.5.exe"
!endif
!ifndef SRC_DIR
